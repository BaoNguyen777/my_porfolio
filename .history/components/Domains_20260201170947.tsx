  ...
  return (
    <section className="mx-auto mt-36 w-full overflow-hidden">
      ...
      >
        ...
        <svg
  width={wrapperSize + 700}
  height={wrapperSize + 700}
  viewBox="0 0 1200 1200"
  className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"
>
  {/* ===== LEFT SEMI CIRCLE (OUTSIDE) ===== */}
  <path
    d="
      M 350 150
      A 450 450 0 0 1 350 1050
    "
    fill="none"
    stroke={activeColor}
    strokeWidth="10"
    ...
    opacity="0.55"
    strokeLinecap="round"
    style={{ animation: "dashDown 8s linear infinite" }}
  />

  {/* ===== RIGHT SEMI CIRCLE (OUTSIDE) ===== */}
  <path
    d="
      M 850 150
      A 450 450 0 0 0 850 1050
    "
    fill="none"
    stroke={activeColor}
    strokeWidth="10"
    ...
    opacity="0.55"
    strokeLinecap="round"
    style={{ animation: "dashUp 8s linear infinite" }}
  />
</svg>
