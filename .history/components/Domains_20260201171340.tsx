  ...
  return (
    <section className="mx-auto mt-36 w-full overflow-hidden">
      ...
      >
        ...
        <svg
  width={wrapperSize + 900}
  height={wrapperSize + 900}
  viewBox="0 0 1200 1200"
  className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"
>
  {/* ===== LEFT ARC – đúng vị trí hình đỏ ===== */}
  <path
    d="
      M 160 280
      A 520 520 0 0 1 160 920
    "
    fill="none"
    stroke={activeColor}
    strokeWidth="10"
    ...
    opacity="0.5"
    strokeLinecap="round"
    style={{ animation: "dashDown 9s linear infinite" }}
  />

  {/* ===== RIGHT ARC – đúng vị trí hình đỏ ===== */}
  <path
    d="
      M 1040 280
      A 520 520 0 0 0 1040 920
    "
    fill="none"
    stroke={activeColor}
    strokeWidth="10"
    ...
    opacity="0.5"
    strokeLinecap="round"
    style={{ animation: "dashUp 9s linear infinite" }}
  />
</svg>
