...
{/* SYSTEM STATUS */}
<div className="mt-6 rounded-2xl border border-emerald-500/20 bg-black/30 p-5">
  <div className="mb-4 flex items-center gap-3">
    <h4 className="text-sm font-semibold tracking-wider text-emerald-400">
      SYSTEM STATUS
    </h4>
  ...
  <div className="space-y-3 text-sm">
    <StatusItem label="Email API" value="99.9%" status="OPERATIONAL" />
    <StatusItem label="Contact Form" value="100%" status="OPERATIONAL" />
    <StatusItem label="Response Time" value="< 24h" status="OPTIMAL" />
  </div>
</div>
