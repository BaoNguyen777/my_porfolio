  ...
  return (
    <section className="mx-auto mt-36 w-full overflow-hidden">
      ...
      >
        ...
        <svg
  width={wrapperSize + 600}
  height={wrapperSize + 600}
...
>
  ...
  <path
    ...
    opacity="0.6"
    style={{ animation: "dashDown 7s linear infinite" }}
  />
  ...
  <path
    ...
    strokeDasharray="14 18"
    opacity="0.6"
    style={{ animation: "dashUp 7s linear infinite" }}
  />
</svg>
