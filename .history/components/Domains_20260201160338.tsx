...
export function Domains() {
    ...
    return (
        <section className="mx-auto mt-36 w-full overflow-hidden">
            ...
            {/* Left ambient */}
<div className="pointer-events-none absolute left-0 top-1/2 h-[500px] w-[280px] -translate-y-1/2 blur-3xl"
     style={{ background: "#6366f1", opacity: 0.08 }} />

{/* Right ambient */}
<div className="pointer-events-none absolute right-0 top-1/2 h-[500px] w-[280px] -translate-y-1/2 blur-3xl"
     style={{ background: "#22d3ee", opacity: 0.08 }} />
