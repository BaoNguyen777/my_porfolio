...
export default function Projects() {
          ...
          >
            ...
            {p.isFlagship && (
              <div className="absolute left-5 top-5 flex items-center gap-2 rounded-full
                bg-emerald-500/25 px-4 py-1 text-xs font-bold text-emerald-300">
  ...
  className={`text-lg font-bold
    ${idx === 0 ? "text-emerald-300" : "text-white"}
  `}
>
  {m.value}
</div>
            ...
            <div className="mt-8 flex justify-end text-white">
              <span className="flex items-center gap-2 text-sm font-semibold text-white/80 hover:text-white transition">
  <span className="border-b border-white/30 pb-[1px]">
    View Project
  </span>
