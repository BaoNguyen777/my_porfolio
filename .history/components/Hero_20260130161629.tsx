...
function AboutTyping() {
  const scripts = [
    // Kịch bản 1 – dài hơn
    "Tôi là một Full Stack Developer tập trung vào xây dựng sản phẩm web có trải nghiệm người dùng tốt, kiến trúc rõ ràng và khả năng mở rộng cao.",

    // Kịch bản 2 – kinh nghiệm + domain
    "Hơn 3 năm kinh nghiệm triển khai website doanh nghiệp, landing page, hệ thống booking và e-commerce.",

    // Kịch bản 3 – cam kết
    "Luôn cam kết sản phẩm đạt chuẩn UX/UI, dễ bảo trì và đáng tin cậy trong vận hành thực tế.",
  ];
  ...
  return (
    <div className="rounded-xl border border-indigo-500/20 bg-black/40 p-5 leading-relaxed min-h-[90px]">
      {text}
