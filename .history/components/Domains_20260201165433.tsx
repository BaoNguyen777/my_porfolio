  ...
  return (
    <section className="mx-auto mt-36 w-full overflow-hidden">
      ...
      >
        {/* ================= CURVED FLOW LINES ================= */}
        <svg
          width={wrapperSize + 260}
          height={wrapperSize + 260}
          viewBox="0 0 800 800"
        ...
        >
          ...
          <path
            ...
            opacity="0.65"
            style={{
              animation: "dashDown 6s linear infinite",
            }}
          />
          ...
          <path
            ...
            opacity="0.65"
            style={{
              animation: "dashUp 6s linear infinite",
            }}
          />
        </svg>
