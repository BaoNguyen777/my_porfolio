  ...
  return (
    <section className="mx-auto mt-40 w-[92%] max-w-7xl">
      ...
      <div className="mb-12 text-center">
        <h2 className="text-5xl font-bold text-white">Liên hệ</h2>
        <p className="mt-3 text-slate-400">
          Sẵn sàng hợp tác cho dự án mới hoặc cơ hội phù hợp
        </p>
      </div>
...
{`const developer = {
  ...
  availability: "Open for freelance & full-time",
        ...
        <motion.div
          whileHover={{
            boxShadow: "0 0 70px -20px rgba(16,185,129,0.5)",
          }}
          ...
          <form className="space-y-4">
            ...
            <button
              ...
              className="mt-4 flex w-full items-center justify-center gap-2
                ...
                hover:-translate-y-1 hover:bg-emerald-400
