...
export function Achievements() {
  const data = [
    ...
    {
      year: "2020",
      title: "Foundation & First Real Projects",
      details: [
        "Bắt đầu làm website doanh nghiệp & landing page thực tế",
        "Làm quen quy trình build web hoàn chỉnh từ UI → Frontend",
        "Hình thành tư duy UX/UI và clean structure",
      ],
    },
    {
      year: "2019",
      ...
      <div className="relative mt-20 flex flex-col items-center">
        ...
        {data.map(item => (
          <div key={item.year} className="relative mb-20 flex flex-col items-center">
            ...
            <div
              className={`rounded-xl border bg-black/100 px-8 py-5 text-center transition-all duration-1000 max-w-xl
