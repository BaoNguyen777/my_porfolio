...
const projects = [
  {
    title: 'WebCraft – Templates & Client Projects',
    desc: 'A production-ready website showcasing real templates and client-ready projects.',
    points: [
      'Built multiple responsive website templates for businesses and personal brands',
      'Focused on clean UI, performance, and real client use cases',
      'Designed to convert visitors into leads or customers'
    ],
    tech: 'Next.js · TailwindCSS · UI/UX · Deployment',
    image: '/projects/webcraft.jpg',
